...
class seatBooker(object):
    ...
    def __getHeaders(self, referURL = 'https://zisu.huitu.zhishulib.com/'):
        """
        获得响应头
    ...
    def __sendBookSeatRequests(self, bookSeatContent, headers):
        ...
        """
        bookSeatURL = 'https://zisu.huitu.zhishulib.com/Seat/Index/bookSeats?LAB_JSON=1'
        try:
    ...
    def __saveTrueCookies(self, loginRequest):
        ...
        for cookie in cookies:
            tempLen = len(' for zisu.huitu.zhishulib.com/>')
    ...
    def __login(self):
        ...
        """
        loginSignatureURL = 'https://zisu.huitu.zhishulib.com/User/Index/login?forward=/Seat/Index/searchSeats?space_category%5Bcategory_id%5D=591&space_category%5Bcontent_id%5D=36&LAB_JSON=1'
        LoginURL = 'https://zisu.huitu.zhishulib.com/api/1/login'
        headers = {
            ...
            'Host': 'zisu.huitu.zhishulib.com',
            'Origin': 'https://zisu.huitu.zhishulib.com',
            'Referer': 'https://zisu.huitu.zhishulib.com/',
    ...
    def __savePartnerID(self, getPartnerIDHeaders):
        ...
        返回值： 无
        """
        getPartnerIDURL = 'https://zisu.huitu.zhishulib.com/User/Index/judgeNameStudentNumber?LAB_JSON=1'
    ...
    def __getWannaSeatID(self, startTime, wannaDuration):
        ...
        """
        getWannaSeatIDURL = 'https://zisu.huitu.zhishulib.com/Seat/Index/searchSeats?LAB_JSON=1'
        getURL = "https://zisu.huitu.zhishulib.com/Seat/Index/searchSeats?space_category%5Bcategory_id%5D=591&space_category%5Bcontent_id%5D={}&LAB_JSON=1".format(str(self.__getTrueRoomNum(int(self.czJson.wannaRoom))))
        wannaSeatID = 0
    ...
    def __bookSeat(self, bookSeatContent, bookSeatHeaders):
        ...
        while Hour != 23 or Mins != 3 or Secs != 11: # 只要还没有到21：59：59那就一直休息
            #这个参数随便给的，自己看着办吧
            Hour,Mins,Secs = self.__getNowHourMinSec()
            time.sleep(0.5)
    ...
    def __getBookedSeatInfo(self,getBookedSeatInfoHeaders):
        ...
        while(requstStatus == False):
            try:
                ...
                seatInfoReq = requests.get('https://zisu.huitu.zhishulib.com/Seat/Index/myBookingList?LAB_JSON=1',headers = headers, timeout=6.3)
